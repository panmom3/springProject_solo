	  ...
	  <div class="header_top">
		<div class="wrap clearfix">
			<ul class="gnb">
				...
				<li class="gnb_list"><a href="${ctp}/member/memberJoin" class="gnb_link"><i class="fa-solid fa-circle-user"></i>회원가입</a></li>
				</c:if>
				<c:if test="${!empty sLevel}">
				<li class="gnb_list"><a href="${ctp}/member/memberLogout" class="gnb_link"><i class="fa-solid fa-right-to-bracket"></i>로그아웃</a></li>
				</c:if>
				<c:if test="${sLevel == 0}">
				<li class="gnb_list"><a href="${ctp}/admin/adminMain" class="gnb_link"><i class="fa-solid fa-user-tie"></i>관리자메뉴</a></li>
				</c:if>
				<c:if test="${!empty sLevel && sLevel != 0}">
				<li class="gnb_list"><a href="${ctp}/member/memberMain" class="gnb_link"><i class="fa-solid fa-user"></i>마이페이지</a></li>
				</c:if>
			</ul>
		</div>
	</div>
			...
			<div class="wrap">
				<div class="depth depth1">
					<ul class="depth_list depth1_list clearfix">
						...
						<li class="depth_item depth1_item">
							<a href="" class="depth_text depth1_text"><span>문의하기</span></a>
						</li>
					</ul>
				</div>
			</div>
