			...
			<tbody class="p-table--th-left">
				...
				<tr>
					<td colspan="2" class="text-center">
						<input type="submit" value="글올리기" class="btn type1 small" />
						<input type="reset" value="다시입력" class="btn type3 small" />
						<input type="button" value="돌아가기" onclick="location.href='boardList';" class="btn type2 small" />
					</td>
				</tr>
			</tbody>
			</table>
