...
public class TravelController {
	...
	public String travelListGet(Model model,
			...
			/*
			 * String imsiChoice = ""; if(choice.equals("최신순")) imsiChoice = "idx"; else
			 * if(choice.equals("추천순")) imsiChoice = "goodCount"; else
			 * if(choice.equals("조회순")) imsiChoice = "readNum"; else
			 * if(choice.equals("댓글순")) imsiChoice = "replyCnt"; else imsiChoice = choice;
			 */
			
			
			List<TravelVO> vos = travelService.getTravelList(startIndexNo, pageSize, part);
